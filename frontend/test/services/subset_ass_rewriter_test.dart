...
''';
    final String output = rewriteAssText(
      input,
      const <String, String>{'example font': 'ABCDEFGH'},
      newline: '\n',
    );
  ...
  test('Property 27: Subset_Rewrite_Ass skip-path leaves originals untouched', () {
    const String input = '[Events]\nDialogue: 0,0,0,Default,{\\fnA}x\n';
    expect(rewriteAssText(input, const <String, String>{}, newline: '\n'), input);
  });
}
